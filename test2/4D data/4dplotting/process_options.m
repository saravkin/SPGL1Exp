% PROCESS_OPTIONS_TO_STRUCT - Processes options passed to a Matlab function.
...
%
% Returns:
%            opts            - a struct of variables that are assigned values
...
%
%     [opts] = process_options_to_struct(varargin, 'u', 0, 'v', 1);
%
% calling func(0, 1, 'v', 2) will assign 0 to opts.x, 1 to opts.y, 0 to opts.u, and 2
% to opts.v.  The parameter names are insensitive to case; calling 
...
%   function y = func(x, y, varargin)
%
%     [opts, unused_args] = process_options(varargin, 'u', 0, 'v', 1);
%
...
function [opts,unused] = process_options(args, varargin)
