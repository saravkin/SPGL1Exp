...
% toc;
% save('/scratch/slic/rkumar/BG5D/Interpolation/Interp_BG5D_rank13.mat','xLS');
%% Plotting the results
% !mkdir rank13iter300
load Interp_BG5D_rank13.mat
...
saveDir = '/scratch/slic/rkumar/BG5D/Interpolation/rank13iter300/';                % directory to save figures in (empty if no figures are to be saved)
dispTitles = false;
axisLabels = true;
