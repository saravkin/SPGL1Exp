...
% toc;
% save('/scratch/slic/rkumar/BG5D/Interpolation/Interp_BG5D_rank20.mat','xLS');
%% Plotting the results
load Interp_BG5D_rank20.mat
...
samplePoints = [31,64,10,13,81,64;36,25,70,3,81,40]; 
...
saveDir = '/scratch/slic/rkumar/BG5D/Interpolation/rank20iter300/';                % directory to save figures in (empty if no figures are to be saved)
dispTitles = false;
axisLabels = true;
