...
opts = spgSetParms('optTol',1e-7, ...
                   ...
                   'iterations', 500,...
                   'weights', []);
LInit   = 1e1*randn(params.numr,params.nr);
RInit   = 1e1*randn(params.numc,params.nr);
...
% toc;
% save('/scratch/slic/rkumar/BG5D/Interpolation/Interp_BG5D_rank12.mat','xLS');
%% Plotting the results
% !mkdir rank12iter300
load Interp_BG5D_rank12.mat
...
samplePoints = [31,64,10,13,81,64;36,25,70,3,81,40]; % want to display sources (1,1) and (1,2)
...
saveDir = '/scratch/slic/rkumar/BG5D/Interpolation/rank12iter300/';                % directory to save figures in (empty if no figures are to be saved)
dispTitles = false;
axisLabels = true;
