...
toc;
save('/scratch/slic/rkumar/BG5D/Interpolation/Interp_BG5D_rank8.mat','xLS');
%% Plotting the results
% load Interp_BG5D_rank8.mat
...
% saveDir = '/scratch/slic/rkumar/BG5D/Interpolation/rank8iter300/';                % directory to save figures in (empty if no figures are to be saved)
% dispTitles = false;
% axisLabels = true;
% 
