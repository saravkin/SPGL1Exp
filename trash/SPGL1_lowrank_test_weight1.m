...
Ind = find(b==0);
params.afun = @(x,Ind)afun(x,Ind);
params.numr = nR;
params.numc = 2*nC;
params.nr = 30; % define here the rank value to evaluate. right now the rank 
% to be assumed is 20.
...
tic;
[xLS,r,g,info] = spgl1(@NLfunForward,b,tau,sigma,xinit,opts,params,Ind);
toc;
...
%W: Linesearch failed with error 1. Damping max BB scaling to 1.0e+04.
